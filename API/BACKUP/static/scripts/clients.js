...
<div class="addNewOrderForm">
    <div class="orderDetails">
        ...
        <div class="input-group">
            <input class="orderDetailsInput orderDetailsInputHalf" required="" value="" placeholder="Street, house number" id="address" type="text"><input class="orderDetailsInput orderDetailsInputHalf" required="" value="" placeholder="City" id="city" type="text">
        </div>
        <div class="input-group">
...
<div class="submitNewOrder">
    <button class="submitNewOrderBtn">
