...
/**
 * Update the Documents when the user is clicked
 */
$('.tableRow').on('click', (e) => {
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('#addClient').addEventListener('click', function() {
        ...
        document.querySelector('.popup').className = 'bodyWrap';
        ...
        closeBtn.addEventListener('click', () => {
            const popup = document.querySelector('.popup');
            document.getElementsByClassName('bodyWrap')[1].className = 'popup'
            popup.innerHTML = '';
